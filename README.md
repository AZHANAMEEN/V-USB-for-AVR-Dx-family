...
                           defined to a value greater than 0. 
                           
...
  -- Make sure to define the D+ And D- pins according to your needs and interrupt availability 
  
...
  
  -- A resistor of 1.5k ohm according to usb ls specs from 3.3v to D- pin. if you do not have a 1.5k use whatever closest value you have try to stay under 3k ohm. 
  
...
  -- You can head over to the github page [DXCore GitHub Repository](https://github.com/SpenceKonde/DxCore) for arduno ide installation. which you can use the library with in arduino ide. 
  ...
  To compile this project locally, head over to the [DXCore GitHub Repository](https://github.com/SpenceKonde/DxCore) to install the hardware core definitions into your Arduino IDE boards manager menu.
